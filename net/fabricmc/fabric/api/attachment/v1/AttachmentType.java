 ...
 *
 * <p>Note on {@link class_1297} and {@link class_2791} targets: in several instances, the game needs to copy data from one instance to another.
 * These are player respawning, mob conversion, return from the End, cross-world entity teleportation, and conversion of a {@link class_2839} to
 * {@link class_2818}. By default, attachments are simply copied wholesale, up to {@link #copyOnDeath()}. Since one instance is discarded,
 * an attachment that keeps a reference to an {@link class_1297} or {@link class_2839} instance can and will break unexpectedly. If,
 * for whatever reason, keeping a reference to the target is absolutely necessary, be sure to implement custom copying logic.
 * For {@link class_1297} targets, use {@link ServerPlayerEvents#COPY_FROM}, {@link ServerEntityWorldChangeEvents#AFTER_ENTITY_CHANGE_WORLD},
 * and {@link ServerLivingEntityEvents#MOB_CONVERSION}. For {@link class_2791} targets, mixin into
 * {@link class_2818#class_2818(class_3218, class_2839, class_2818.class_6829)}.
 * </p>
 *
 ...
 * @see AttachmentRegistry.Builder#syncWith(class_9139, AttachmentSyncPredicate)
 */
